	...
	<nav class="navbar navbar-expand-lg py-2 navbar-light bg-light">
  		...
  		<div class="collapse navbar-collapse text-right" id="navbarSupportedContent">
    		<ul class="navbar-nav ml-auto">
      			...
      			<li class="nav-item <?= ($activePage == 'main_properties') ? 'active':''; ?>">
        			<a class="nav-link pr-5 text-uppercase font-weight-normal" href="main_properties.php" >Dreamland Properties</a>
      			</li>
      			<li class="nav-item <?= ($activePage == 'main_tours') ? 'active':''; ?>">
        			<a class="nav-link pr-5 text-uppercase font-weight-normal" href="main_tours.php">Dreamland Tours</a>
      			</li>
      			<li class="nav-item <?= ($activePage == 'main_contact') ? 'active':''; ?>">
        			<a class="nav-link pr-5 text-uppercase font-weight-normal" href="main_contact.php" >Contact</a>
      			</li>
